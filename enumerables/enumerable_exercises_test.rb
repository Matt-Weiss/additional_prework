...
class EnumerablesTest < Minitest::Test
  ...
  def test_words_with_no_vowels
    ...
    actual = words.collect do |word|# Your Code Here
      word.delete "aeiou"
    end
  ...
  def test_has_at_least_one_zero
    ...
    numbers = [2, 0, 9, 3, 0, 1]
     actual = numbers.include? (0) #Your Code Here
  ...
  def test_all_gone
    ...
    actual = words.all? {|word| word == "gone"}# Your Code Here
    assert_equal true, actual
  end
  ...
  def test_count_numbers_greater_than_17
    ...
    count = numbers.select {|num| num > 17}
  ...
  def test_array_with_the_most_items
    ...
    actual = arrays.max_by{|array| array.length}# Your Code Here
  ...
  def test_group_words_by_first_letter
    ...
    actual = words.group_by {|word| word.chr}#Your Code Here
  ...
  def test_none_are_negative
    ...
    actual = numbers.all? {|number| number > 0}# Your Code Here
    assert true, actual
  end
  ...
  def test_one_time
    ...
    actual = words.one? {|word| word == "time"}# Your code goes here
    assert_equal true, actual
  end
  ...
  def test_sum_a_list_of_numbers
    ...
    # initial value is 0
    actual = numbers.inject(0) {|sum, number| sum + number}
  ...
  def test_remove_numbers_divisible_by_3
    ...
    actual = numbers.reject {|number| number % 3 == 0}# Your Code Here
  ...
  def test_sort_alphabetically
    ...
    actual = words.sort {|a, b| a.downcase <=> b.downcase}# Your Code Here
  ...
  def test_all_4_letter_words
    ...
    actual = words.all? {|word| word.length ==4}# Your Code Here
    assert_equal true, actual
  end
  ...
  def test_has_a_multi_word_phrase
    ...
    actual = phrases.any? {|phrase| phrase.include? (" ")}# Your Code Here
    assert_equal true, actual
  end
  ...
  def test_count_words_that_are_uppercase
    ...
    actual = (words.select {|word| word.upcase == word}).count# Your Code Here
  ...
  def test_multiply_list_of_numbers
    ...
    numbers = [2, 3, 5, 7]
    # initial value is 1
    actual = numbers.inject(1) {|total, number| total * number}
  ...
  def test_sort_by_distance
    ...
    actual = distances.sort_by {|distances| distances.to_i}
  ...
  def test_all_multiples_of_7
    ...
    actual = numbers.collect {|num| num % 7 == 0}
    assert actual
  end
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    actual = keywords.inject('one fish two fish red fish blue fish') {|initial_value, keyword| initial_value.gsub(keyword, keyword.upcase)}
  ...
  def test_subtract_smallest_values_from_100
    ...
    actual = elements.inject(100) {|total, element| total - element.sort[0]}
  ...
  def test_one_double_digit_number
    ...
    actual = numbers.one? {|number| (number.digits).length == 2}
    assert actual
  end
  ...
  def test_group_by_number_of_zeros
    ...
    actual = numbers.group_by {|number| (number.digits).count(0)}
  ...
  def test_count_round_prices
    ...
    actual = prices.count {|number| number == number.round}
    assert_equal 2, actual
  end
