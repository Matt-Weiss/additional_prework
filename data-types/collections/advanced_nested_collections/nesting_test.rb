...
class NestedTest < MiniTest::Test
  ...
  def test_list_of_dishes_names_for_olive_garden
    #=======================
    dishes_names = stores[:olive_garden][:dishes].map {|key| key[:name]}
    #=======================
  ...
  def test_list_of_all_ingredients_across_all_restaurants
    ...
    #=======================
    ingredients = stores.map {|key, value| value[:dishes].map{|key| key[:ingredients]}}.flatten
    #=======================
    assert_equal ["Rice",
                  "Cheese",
                  "Butter",
  ...
  def test_full_menu_price_for_olive_garden
    ...
    #=======================
    full_menu_price = stores[:olive_garden][:dishes].map {|key| key[:price]}.sum
    #=======================
